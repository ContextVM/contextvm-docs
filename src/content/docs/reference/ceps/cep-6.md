...
**Note**: For tools list announcements (kind 11317), see [CEP-15: Common Tool Schemas](/reference/ceps/cep-15) for additional tag conventions that enable schema discovery and ecosystem integration.
...
- [CEP-15: Common Tool Schemas](/reference/ceps/cep-15) — Extends tools list announcements with schema discovery and NIP-73 integration
