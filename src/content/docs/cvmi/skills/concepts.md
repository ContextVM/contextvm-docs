---
title: ContextVM Concepts
description: Core concepts, architectural decisions, and common questions about ContextVM.
---

# ContextVM Concepts

Core concepts, architectural decisions, and frequently asked questions about ContextVM.
...
```bash
cvmi serve --private-key "your-key" \
...
Use `@contextvm/sdk` for TypeScript applications with [`NostrServerTransport`](/ts-sdk/transports/nostr-server-transport) and [`NostrClientTransport`](/ts-sdk/transports/nostr-client-transport).

## Related Resources

- [ContextVM Protocol Overview](/cvmi/skills/overview) — Protocol fundamentals
