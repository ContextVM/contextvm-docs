...
This tutorial covers the _consumer_ side of CEP-6: querying relays to find active ContextVM servers and inspecting their available MCP tools.
...
- [CEP-17 Relay Discovery](/reference/ceps/cep-17): Learn how to discover _which relays_ a server uses, so you don't have to hardcode them.
