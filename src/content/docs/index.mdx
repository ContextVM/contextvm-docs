...
<CardGrid stagger>
  <IconLinkCard
    title="Architecture"
    icon="rocket"
    href="https://github.com/ContextVM/contextvm-docs/blob/master/src/content/docs/reference/spec/ctxvm-draft-spec.md#complete-protocol-flow"
    description="Learn the foundational concepts and architecture of ContextVM"
    target="_blank"
  />
  <IconLinkCard
    title="TS SDK Documentation"
    icon="add-document"
    href="reference/ts-sdk/quick-overview/"
    description="Explore our comprehensive TypeScript SDK documentation and implementation examples"
    target="_blank"
  />
  <IconLinkCard
    title="Rust SDK Documentation"
    icon="add-document"
    href="reference/rs-sdk/overview/"
    description="Explore our Rust SDK documentation, transports, and native integration guides"
    target="_blank"
  />
  <IconLinkCard
    title="Integrations"
    icon="puzzle"
    href="reference/ts-sdk/gateway/overview/#integration-scenarios"
  ...
  <IconLinkCard
    title="Tutorials"
    icon="open-book"
    href="tutorials/client-server-communication/"
  ...
  <IconLinkCard
    title="Payments"
    icon="nostr"
    href="how-to/payments/getting-started/"
