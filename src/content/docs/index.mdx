...
<CardGrid stagger>
  <Card title="Architecture" icon="rocket" link="https://github.com/ContextVM/sdk/blob/master/docs/ctxvm-draft-spec.md#complete-protocol-flow">
    Learn the foundational concepts and architecture of ContextVM
  </Card>
  <Card title="SDK Documentation" icon="add-document" link="ts-sdk/quick-overview/">
    Explore our comprehensive documentation and implementation examples
  </Card>
  <Card title="Integrations" icon="puzzle" link="spec/ctxvm-draft-spec/">
